    ...
    <div id="main">
        ...
        <div id="main_name">
            ...
            <form action="<c:url value='/StuRegist'/>" method="post">
                ...
                <span id="user">用户名</span><input type="text" name="name" value="${student.name}" maxlength="8" size="20">${errors.name}<br>
                <span id="user">密码</span>&nbsp;&nbsp;&nbsp;<input type="text" name="password" value="${student.password}" maxlength="8" size="20">${errors.password}<br>
