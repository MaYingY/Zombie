    ...
    <div id="main">
        ...
        <div id="main_name">
            ...
            <form action="<c:url value="/StuServlet?method=rentBook"/>" method="post">
                <span id="user">用户名</span><input type="text" name="stuName"><br>
                <span id="user">图书名称</span><input type="text" name="bookName"><br>
                 <span id="user">借阅天数</span><input type="text" name="days"><br><br>
